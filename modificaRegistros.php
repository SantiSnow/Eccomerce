...
<hr>
<h2 id="tituloResultadoBusqueda">Formulario para modificar precios de la base de datos</h2>
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<br />
			...
			<br />
			<p>Si desea eliminar productos, haga click aqui:</p>
			<a href="eliminarRegistros.php" title="Eliminar productos">Formulario para eliminar productos</a>
			<br />
			<p>Si desea volver a la pagina de empleados, haga click aqui:</p>
			<a href="paginaEmpleados.php" title="Lista de productos">Formulario para agregar productos</a>			
		</div>
	</div>
</div>
