...
<hr>
<h2 id="tituloResultadoBusqueda">Registro de empleados en la base de datos</h2>
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<br />
			<br />		
			 ...
			 require("conexion.php");
                ...
                $email= mysqli_escape_string ($conexion, $_GET["email"]);
                $edad= mysqli_escape_string ($conexion, $_GET["edad"]);
                $codigoempleado= mysqli_escape_string ($conexion, $_GET["codigoEm"]);
                $password= mysqli_escape_string ($conexion, $_GET["password"]);
                $seccion= mysqli_escape_string ($conexion, $_GET["seccion"]);
                ...
                $consulta = "INSERT INTO EMPLEADOS VALUES('$nombre', '$email', '$seccion', '$password', $edad, '$codigoempleado')";
                ...
                if($resultado == false){
                    ...
                    if(mysqli_affected_rows($conexion) == 0){
                        echo "No se pudo registrar al empleado, no se efectuaron cambios, intentelo de nuevo.";
                        echo "<br /><a href='loginEmpleados.php' title='volver'>Volver</a>";
                    }
                    else{
                        echo "Se han registrado en la base de datos correctamente";
                        echo "<br /><a href='paginaEmpleados.php' title='Haga click para comenzar'>Pagina de empleados.</a>";
                    }
                }
