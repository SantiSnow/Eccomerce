...
<div class="container">
	<div class="row">
			 ...
			 $codigo= $_GET["codigoarticulo"];
                ...
                if($resultado == false){
                    ...
                    if(mysqli_affected_rows($conexion) == 0){
                        ...
                        echo "Se han eliminado correctamente los registros de la base de datos con codigo: " . $codigo;
                    }
                }
		...
		<br />
		<br />
		<a href="eliminarRegistros.php" title="Haga click para eliminar otro articulo">Eliminar otro articulo.</a>
		<br />
		<br />
