...
<!-- Aqui comienza el detalle de producto -->

<div class="container">
	<div class="row">
		<div class="col-md-5"> 
			<img src="images/asusE402.jpg" alt="Imagen Producto" id="imgDescrip" />
			<figcaption>Imagen descriptiva</figcaption>
		</div>
		<div class="col-md-7">
			<h3>Detalle del Producto</h3>
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, vitae doloremque voluptatum doloribus neque 
			assumenda velit sapiente quas aliquam ratione. Sed possimus corporis dolorum optio eaque in asperiores soluta expedita!</p>
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, vitae doloremque voluptatum doloribus neque 
			assumenda velit sapiente quas aliquam ratione. Sed possimus corporis dolorum optio eaque in asperiores soluta expedita!</p>
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, vitae doloremque voluptatum doloribus neque 
			assumenda velit sapiente quas aliquam ratione. Sed possimus corporis dolorum optio eaque in asperiores soluta expedita!</p>
			<br />
			<br />
			<p>Agregamos detalles como precio, stock, y otros</p>
			<br />
