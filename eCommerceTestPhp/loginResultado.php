...
<hr>
<h2 id="tituloResultadoBusqueda">Ingreso de empleados</h2>
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<br />
			<br />		
			 ...
			 require("conexion.php");
                ...
                $consulta = "SELECT * FROM EMPLEADOS WHERE EMAIL='$email' AND PASS='$password';";
                
                $resultado = mysqli_query($conexion, $consulta);
                
                if($resultado == null){
                    echo "No se encontro el usuario.";
                    echo "<br /><a href='login.php' title='volver'>Volver</a>";
                    echo "<br />";
                    echo (mysqli_error($conexion));
                }
                else{
                    echo "Se han ingresado correctamente con sus datos, bienvenido";
                    echo "<br /><p>Haga click aqui para comenzar a trabajar: </p><a href='paginaEmpleados.php' title='Haga click para comenzar'>Pagina de empleados.</a>";
                }
