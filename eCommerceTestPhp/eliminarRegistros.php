...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			...
			<br />
			<div class=form-group>
    			<form method="get" action="eliminarRegistroResultado.php">
    				<p>Bienvenido a la seccion para empleados para el sistema de productos. Aqui puede eliminar productos de la base
