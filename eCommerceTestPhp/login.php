...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			...
			<br />
			<div class=form-group>
    			<form method="get" action="loginResultado.php">
    				<p>Bienvenido a la seccion para empleados para el sistema de productos. Aqui puede ingresar con su usuario para comenzar a agregar,
    				modificar, eliminar o consultar productos de la base de datos del sistema</p>
    				<br />
    			...
    			<br />
				<br />
				<p>Si necesita registrarse, haga click aqui: <a href="loginEmpleados.php" title="Registrarse">Registrarse</a></p>
			</div>
		</div>
	</div>
</div>
