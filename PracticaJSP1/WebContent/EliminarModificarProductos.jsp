	...
	<div class='row'>
		...
		<div class='col-md-5'>
			...
			<div class='form-group'>
					...
					eliminar un producto, solo podra volver a ingresarlo a la base de datos manualmente con los datos correctos.</p>
					<br /><br />			
					...
					<br /><br />
					<a href='paginaEmpleados.jsp' title='Inicio'>Inicio empleados</a>
       			<br />
       			<br />
			</div>
		</div>
