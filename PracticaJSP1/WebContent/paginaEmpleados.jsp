		...
		<div class='col-md-9'>
			...
			try{
				...
				if(miResultado.absolute(1)){
					...
					out.println("<br /><br />Si lo desea, puede ver la lista de productos completa aqui: " + "<br /><br /><a href='ListaCompletaProductos.jsp' title='Lista completa sin formato'>Lista de productos completa</a>");
					out.println("<br /><br />Aqui puede introducir productos a la base de datos del sistema, ingrese codigo, precio, nombre y seccion sin dejar campos sin rellenar o no se realizara la consulta.");
					out.println("Para que la base de datos se mantenga organizada se recomienda introducir los productos en letras mayusculas, si no conoce los datos del producto, consulte a su supervisor.");
					out.println("<br /><br /><a href='IngresoProductos.jsp' title='Ingreso Productos'>Ingresar Productos al sistema</a>");
					
					out.println("<br /><br />Para eliminar o modificar productos, haga click aqui:");
					out.println("<br /><br /><a href='EliminarModificarProductos.jsp' title='Eliminar o modificar'>Eliminar o modificar productos</a>");
				}
				else{
