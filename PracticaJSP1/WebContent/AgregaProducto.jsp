...
String instruccionSql = "INSERT INTO PRODUCTOS (CODIGOARTICULO, NOMBREARTICULO, SECCION, PRECIO) VALUES ('" + codigoArticulo + "', '"+ nombreArticulo +"', '"+ seccion +"', '"+ precio +"');";
	...
	<div class="row">
		<div class="col-md-9">
			...
			<div class="form-group">
        			...
        			<br />
        			<br />
        			<p>Para agregar mas productos, puede hacer click aqui: <a href="paginaEmpleados.jsp" title="Agregar Productos">Agregar Productos</a></p>
        			<br />
