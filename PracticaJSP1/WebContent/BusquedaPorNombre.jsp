...
<hr>
<h2 class="text-center">Visite nuestras ofertas</h2>
<hr>
<div class="container">
	<div class="row">
		<div class="col-md-9">
			...
			<div class="container">
				...
				//cookie de busqueda
				Cookie laCookie = new Cookie ("ultimaBusqueda", parametroBusqueda);
				...
				response.addCookie(laCookie);
					...
					try{
						...
						while(miResultado.next()){
							...
							out.println("<form>");
							out.println("<strong>Producto encontrado</strong>");
							out.println("<br />");
							out.println("<img src='images/400X200.gif' alt='Thumbnail Image 1' class='img-responsive'>");
							...
							out.println("<br /><br />");
							out.println("<a href=''#' class='btn btn-primary' role='button'>Agregar al carrito</a><br /><br />");
							out.println("</form>");
							out.println("</div>");
						}
